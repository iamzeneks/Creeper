...
一张普通得不能再普通的照片，里面可能藏着一份合同；一首歌，里面可能藏着一串密码。Creeper 把任意文件**加密后藏进一张图片、一段音乐或一个 WAV 音频**——载体照常能看、能播放、能分享、能同步云端，谁也看不出异常；真正的内容，只有知道密码的人取得出。
...
**不是**：
- **不是"加密压缩包"**。加密 zip / 加密 PDF / 加密磁盘，都会把"这里有个受保护的文件"写在明面上，看见的人立刻知道"有东西"；而 Creeper 藏完之后，载体只是普通媒体——防的不只是"解不开"，而是**"根本不知道有东西可解"**。
