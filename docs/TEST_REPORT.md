...
- **容量标定**：134MB WAV（16bit stereo）：depth=1 100% ≈ 4.4 MB / 15% ≈ 658 KB；depth=2 100% ≈ 8.8 MB / 15% ≈ 1.3 MB；样本差 ≤3 = -78 dBFS（仍不可闻），统计暴露略增（低 2 bit 均匀化），15% 上限下可控